CREATE TABLE [dw].[DIM_IT_STAFF_WRKGRP] (
    [SK_DIM_IT_STAFF_WRKGRP] BIGINT         IDENTITY (1, 1) NOT NULL,
    [FK_DIM_SECURITYGUARD]   BIGINT         NOT NULL,
    [P_EmployeeId]           NVARCHAR (255) NULL,
    [P_ValidFrom]            DATE           NULL,
    [P_ValidTo]              DATE           NULL,
    [P_WorkGroupName]        VARCHAR (255)  NULL,
    [P_WorkGroupCode]        VARCHAR (255)  NULL,
