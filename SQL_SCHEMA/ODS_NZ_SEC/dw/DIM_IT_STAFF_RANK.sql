CREATE TABLE [dw].[DIM_IT_STAFF_RANK] (
    [SK_DIM_IT_STAFF_RANK] BIGINT         IDENTITY (1, 1) NOT NULL,
    [FK_DIM_SECURITYGUARD] BIGINT         NOT NULL,
    [P_EmployeeId]         NVARCHAR (255) NULL,
    [P_RankReference]      NVARCHAR (255) NULL,
    [P_Note]               NVARCHAR (255) NULL,
    [P_RankName]           NVARCHAR (255) NULL,
    [P_RankShortName]      NVARCHAR (255) NULL,
