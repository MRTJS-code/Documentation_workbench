CREATE TABLE [dw].[FACT_DESPATCH] (
    ...
    [FK_DIM_CLIENTLOCATION]        BIGINT          NULL,
    ...
    [FK_TEMP_ADDRESS]              BIGINT          NULL,
    [FK_REPORTING_ADDRESS]         BIGINT          NULL,
    [P_Alarm_Docket_Id]            INT             NULL,
    [P_KDTNo]                      VARCHAR (16)    NULL,
    [P_Other_Docket_Type]          INT             NULL,
    ...
    [P_Final_OnSite_DateTime]      DATETIME        NULL,
    [P_Final_OffSite_DateTime]     DATETIME        NULL,
    [P_Response_Minutes]           INT             NULL,
    [P_Acknowledge_Minutes]        INT             NULL,
    [P_OnSite_Minutes]             INT             NULL,
    [P_Extra_OnSite_Minutes]       INT             NULL,
    [P_Over_Response_Time_Minutes] INT             NULL,
    ...
    [P_Allowed_Time_On_Site]       INT             NULL,
    [P_OnSite_Time_Variation]      INT             NULL,
    [P_Onsite_Lat]                 VARCHAR (64)    NULL,
    [P_Onsite_Long]                VARCHAR (64)    NULL,
    [P_Final_Onsite_Lat]           VARCHAR (64)    NULL,
    [P_Final_Onsite_Long]          VARCHAR (64)    NULL,
